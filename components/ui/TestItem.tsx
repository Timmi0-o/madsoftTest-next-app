...
export const TestItem = ({
	...
	return (
		<>
			<div className='relative flex flex-col items-center gap-[20px] w-[400px] h-[600px] border-[#ADB5BD] border-[1px] rounded-[12px] cursor-pointer duration-300 hover:shadow-lg '>
				<div className='relative w-[380px] h-[260px] rounded-[8px] bg-[#E9ECEF] border-[1px] border-[#ADB5BD] mt-[10px]'>
					<Image
				...
				<div className='flex flex-col gap-[30px] w-[380px]'>
					<p className='text-[28px] font-medium text-[#343A40] px-[5px] rounded-[8px] bg-[#DEE2E6] border-x-[1px] border-x-[#212529] min-w-[300px] text-center'>
						{title}
					</p>
